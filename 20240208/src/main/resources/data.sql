...
INSERT INTO article(title, content) values ('임꺽정', '처언재');
INSERT INTO article(title, content) values ('장길산', '처어언재');
INSERT INTO article(title, content) values ('일지매', '처어어언재');

-- article 더미데이터
INSERT INTO article(title, content) values ('손오공', '좋아하는 드라마는?');
INSERT INTO article(title, content) values ('저팔계', '먹고싶은 음식은?');
INSERT INTO article(title, content) values ('사오정', '취미는?');
